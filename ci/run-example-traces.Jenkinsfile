        ...
        node('docker') {
          stage(name) {
            ...
            docker.image('ctsrd/testrig-exampletraces').inside {
              ...
              sh "mkdir ${name}/tests && find /home/jenkins/TestRIG_exampleTraces/ -type f | grep -xvf /home/jenkins/TestRIG_exampleTraces/ci/implementation-independent.ignore | xargs cp -t ${name}/tests --parents"
